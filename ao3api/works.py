...
class Work(object):
    ...
    def chapters(self):
        ...
        value = self._lookup_stat('chapters')
    ...
    def comments(self):
        ...
        return int(self._lookup_stat('comments', 0).replace(',',''))

    @property
    def kudos(self):
        """The number of kudos on this work."""
        return int(self._lookup_stat('kudos', 0).replace(',',''))
    ...
    def bookmarks(self):
        ...
        return int(self._lookup_stat('bookmarks').contents[0].replace(',',''))

    @property
    def hits(self):
        """The number of hits this work has received."""
        return int(self._lookup_stat('hits', 0).replace(',',''))
